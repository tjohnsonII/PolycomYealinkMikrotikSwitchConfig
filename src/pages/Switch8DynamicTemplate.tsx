...
const defaultSwitch8Config = `no service pad
  ...
  const handleDownload = () => {
    ...
    if (downloadRef.current) {
      const fileName = hostname 
        ? `${hostname.replace(/[^a-zA-Z0-9]/g, '_')}_8Port_Config.txt`
        : '8Port_Switch_Config.txt';
    ...
    <div>
      ...
      <div style={{ marginBottom: 12 }}>
        <button 
          ...
          title="Download the configured 8-port switch template as a .txt file"
        >
...
export default Switch8DynamicTemplate;
