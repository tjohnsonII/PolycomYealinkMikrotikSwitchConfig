      ...
      <div className="ata-clean-header">
        ...
        <div className="ata-clean-tab-container">
          <button
            ...
            className={`ata-clean-tab-button ${activeTab === 'general' ? 'active' : ''}`}
            title="General ATA configuration settings"
          >
            General ATA Config
          </button>
          <button
            onClick={() => setActiveTab('grandstream')}
            className={`ata-clean-tab-button ${activeTab === 'grandstream' ? 'active' : ''}`}
            title="Grandstream-specific configuration"
          >
            Grandstream Specific Config
          </button>
          <button
            onClick={() => setActiveTab('cisco')}
            className={`ata-clean-tab-button ${activeTab === 'cisco' ? 'active' : ''}`}
            title="Cisco SPA 122 specific configuration"
          >
        ...
        {activeTab === 'general' && (
          <div className="ata-clean-tab-content">
            ...
            {/* Extension Configuration */}
            <div className="ata-clean-extension-section">
              <h3 className="ata-clean-extension-title">
                Extension Configuration
              </h3>
              ...
              <div className="ata-clean-form-group">
                ...
                <input
                  ...
                  placeholder="2001"
                  className="ata-clean-form-input"
                  title="Enter fax extension number"
                />
              </div>
              ...
              <div className="ata-clean-form-group">
                ...
                <input
                  ...
                  className="ata-clean-form-input"
                  title="Enter fax extension password"
                />
              </div>
              ...
              <div className="ata-clean-form-group">
                ...
                <input
                  ...
                  placeholder="2002"
                  className="ata-clean-form-input"
                  title="Enter analog extension number"
                />
              </div>
              ...
              <div className="ata-clean-form-group">
                ...
                <input
                  ...
                  placeholder="Extension password"
                  className="ata-clean-form-input"
                  title="Enter analog extension password"
                />
              </div>
            </div>

            {/* Audio and Codec Settings */}
            <div className="ata-clean-audio-section">
              <h3 className="ata-clean-audio-title">
              ...
              <div className="ata-clean-form-group">
                <label className="ata-clean-checkbox-label">
                  <input
                    ...
                    title="Enable or disable echo cancellation"
                  />
                  Enable Echo Cancellation
                </label>
                <small className="ata-clean-help-text">
            ...
            {/* Advanced Settings */}
            <div className="ata-clean-advanced-section">
              <h3 className="ata-clean-advanced-title">
                Advanced Settings
              </h3>
        ...
        {activeTab === 'grandstream' && (
          <div className="ata-clean-tab-content">
            <div className="ata-clean-grandstream-info">
              <h3 className="ata-clean-grandstream-info-title">
                📠 Grandstream ATA - Step by Step Configuration
              </h3>
              <p className="ata-clean-grandstream-info-text">
            ...
            <div className="ata-clean-grandstream-config-section">
              <h3 className="ata-clean-grandstream-config-title">
                Configuration Parameters
              </h3>
              
              <div className="ata-clean-config-grid">
                <div className="ata-clean-form-group">
                  <label className="ata-clean-form-label">
                    Customer Handle:
                  </label>
                  <input
                    ...
                    className="ata-clean-form-input"
                    title="Enter customer handle identifier"
                  />
                </div>
            ...
            <div className="ata-clean-grandstream-steps">
              <h3 className="ata-clean-grandstream-steps-title">
                📋 Grandstream Configuration Steps
              </h3>
              
              <ol className="ata-clean-steps-list">
                ...
                <li><strong>Basic Settings:</strong> Navigate to Basic Settings and configure:
                  <ul className="ata-clean-steps-sublist">
        ...
        {activeTab === 'cisco' && (
          <div className="ata-clean-tab-content">
            <div className="ata-clean-cisco-info">
              <h3 className="ata-clean-cisco-info-title">
                📠 Cisco SPA 122 ATA - Step by Step Configuration
              </h3>
              <p className="ata-clean-cisco-info-text">
                This guide provides detailed instructions for configuring Cisco SPA 122 ATAs with fax-optimized settings.
              </p>
            </div>

            {/* Configuration Input Form */}
            <div className="ata-clean-cisco-config-section">
              <h3 className="ata-clean-cisco-config-title">
                Configuration Parameters
              </h3>
            ...
            <div className="ata-clean-cisco-steps-section">
              <h3 className="ata-clean-cisco-steps-title">
                📋 Step-by-Step Configuration Instructions
              </h3>
              
              <div className="ata-clean-cisco-warning">
              ...
              <ol className="ata-clean-steps-list">
                ...
                <li><strong>Initial Login:</strong> Once factory defaulted, log into the ATA via web browser using default credentials:
                  <ul className="ata-clean-steps-sublist">
                    <li>Username: <code className="ata-clean-code-highlight">admin</code></li>
                    <li>Password: <code className="ata-clean-code-highlight">admin</code></li>
                  </ul>
                </li>
                ...
                <li><strong>Post-Firmware Access:</strong> After firmware update, access the ATA locally via Ethernet port on IP address:
                  <code className="ata-clean-code-highlight-margin">192.168.15.1</code>
                ...
                <li><strong>Change Admin Password:</strong>
                  <ul className="ata-clean-steps-sublist">
                    ...
                    <li>Set password to: <code className="ata-clean-code-highlight">08520852</code></li>
                ...
                <li><strong>Configure Line 1:</strong> Go to <strong>Voice</strong> → <strong>Line 1</strong> and configure the following sections:
                  ...
                  <div className="ata-clean-cisco-substeps">
                    <h4 className="ata-clean-cisco-substep-title">a. Network Settings:</h4>
                    <ul>
                    ...
                    <h4 className="ata-clean-cisco-substep-title-spaced">b. Proxy and Registration:</h4>
                    <ul>
                      <li>Enter PBX IP Address: <strong>{ciscoConfig.pbxIP || '[Enter PBX IP]'}</strong></li>
                    </ul>
                    
                    <h4 className="ata-clean-cisco-substep-title-spaced">c. Subscriber Information:</h4>
                    <ul>
                    ...
                    <h4 className="ata-clean-cisco-substep-title-spaced">d. Supplementary Service Subscription:</h4>
                    <ul>
                    ...
                    <h4 className="ata-clean-cisco-substep-title-spaced">e. Audio Configuration:</h4>
                    <ul>
                      <li>Set <strong>Second Preferred Codec</strong> to <strong>G711a</strong></li>
                      <li>Set the following to <strong>Yes</strong>:
                        <ul className="ata-clean-cisco-substep-list">
                          <li>G729a Enable</li>
                          <li>G726a Enable</li>
            ...
            {/* Additional Notes */}
            <div className="ata-clean-cisco-notes">
              <h4 className="ata-clean-cisco-notes-title">
                📝 Additional Configuration Notes:
              </h4>
              <ul className="ata-clean-cisco-notes-list">
          ...
          <div className="ata-clean-output-container">
            <div className="ata-clean-output-header">
              ...
              <div className="ata-clean-output-buttons">
                ...
                <button
                  ...
                  className="ata-clean-download-button"
            ...
            <div className="ata-clean-output-section">
              ...
              <textarea
                ...
                placeholder="Generated configuration will appear here after filling in the form..."
              />
            </div>
          </div>
        )}
