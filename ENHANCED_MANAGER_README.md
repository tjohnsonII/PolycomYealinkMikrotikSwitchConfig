...
- **External**: [https://123hostedtools.com:8443](https://123hostedtools.com:8443)
- **Local**: [https://localhost:8443](https://localhost:8443)
- **LAN**: [https://[YOUR-IP]:8443](https://[YOUR-IP]:8443)

### **Health Endpoints**

- **Proxy**: [https://localhost:8443/proxy-health](https://localhost:8443/proxy-health)
- **Auth**: [https://localhost:8443/api/auth/health](https://localhost:8443/api/auth/health)
- **SSH-WS**: [https://localhost:8443/api/health](https://localhost:8443/api/health)
